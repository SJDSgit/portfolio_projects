from tkinter import *
from script1_bookstore_backend import Database
...
class Window(object):
    ...
    def __init__(self,window):
        ...
        self.window.wm_title("Bookstore Inventory")
    ...
    def add_command(self):
        ...
        self.lb1.delete(0,END)
        self.lb1.insert(END,(self.title_text.get(),self.author_text.get(),self.year_text.get(),self.isbn_text.get()))
